...
void ProfilePlotOptionsDialog::TransferCustomDataFromWindow() {
  ...
  // transfers color-method
  pickerctrl = XRCCTRL(*this, "colorpicker_method", wxColourPickerCtrl);
  options_modified_.color_method = pickerctrl->GetColour();
...
void ProfilePlotOptionsDialog::TransferCustomDataToWindow() {
  ...
  // transfers color-method
  pickerctrl = XRCCTRL(*this, "colorpicker_method", wxColourPickerCtrl);
  pickerctrl->SetColour(options_modified_.color_method);
